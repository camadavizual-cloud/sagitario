...
export default function Home() {
  ...
  return <>
    <main className="appShell">
      <header className="topbar"><Brand /><div className="headerActions"><a className="adminButton desktopAdminLink" href="https://frame-rec-administracao-comercial.produframe.chatgpt.site" target="_blank" rel="noreferrer" aria-label="Abrir Administração Comercial em uma nova aba"><span aria-hidden="true">⚙</span> Admin</a><button className="secondaryButton" onClick={clearSelection}>Limpar seleção</button></div></header>
      ...
      <nav className="mobileQuickNav" aria-label="Atalhos da proposta"><a href="#services">Serviços <b>{selectedServices.length}</b></a><a href="#comparison">Comparar</a><a className="adminQuickLink" href="https://frame-rec-administracao-comercial.produframe.chatgpt.site" target="_blank" rel="noreferrer" aria-label="Abrir Administração Comercial em uma nova aba">⚙ Admin</a></nav>
